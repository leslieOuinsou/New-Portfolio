...
export type IridescenceProps = {
  /** Couleur multiplicatrice du shader (RGB 0–1) — évite le nom `color` (réservé au HTML) */
...
export function Iridescence({
  ...
  useEffect(() => {
    ...
    const mouseBuf = new Float32Array([mousePos.current.x, mousePos.current.y]);
  ...
  }, [mixColor, speed, amplitude, mouseReact]);
