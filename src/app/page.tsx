  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-16 sm:pt-20 overflow-hidden">
        {/* Animation Hyperspeed en arrière-plan */}
        <Suspense fallback={<div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-black" />}>
          <Hyperspeed 
            effectOptions={{
            colors: {
              roadColor: isDarkMode ? 0x080808 : 0x2a2a2a,
              islandColor: isDarkMode ? 0x0a0a0a : 0x3a3a3a,
              background: isDarkMode ? 0x000000 : 0x1a1a1a,
              shoulderLines: isDarkMode ? 0xffffff : 0x666666,
              brokenLines: isDarkMode ? 0xffffff : 0x666666,
              leftCars: isDarkMode ? [0xd856bf, 0x6750a2, 0xc247ac] : [0x0077FF, 0x0056CC, 0x003d99],
              rightCars: isDarkMode ? [0x03b3c3, 0x0e5ea5, 0x324555] : [0x00D4FF, 0x0099CC, 0x006699],
              sticks: isDarkMode ? 0x03b3c3 : 0x0077FF
            },
      ...
      <footer className={`relative overflow-hidden transition-colors duration-300 ${
        ...
        <div className="absolute inset-0">
          <motion.div
            ...
            transition={{ duration: 2, delay: 0.5 }}
            viewport={{ once: true }}
            className="absolute top-10 left-10 w-32 h-32 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full blur-3xl"
          />
          <motion.div
            initial={{ opacity: 0, scale: 0 }}
            whileInView={{ opacity: 0.08, scale: 1 }}
            transition={{ duration: 2, delay: 0.8 }}
            viewport={{ once: true }}
            className="absolute bottom-10 right-10 w-40 h-40 bg-gradient-to-r from-green-400 to-blue-500 rounded-full blur-3xl"
          />
        </div>

        {/* Contenu principal */}
        <div className="relative z-10 border-t border-opacity-20 py-16 sm:py-20">
            ...
            <div className="grid md:grid-cols-3 gap-8 sm:gap-12 mb-12">
              ...
              >
                ...
                <p className={`text-base sm:text-lg mb-6 ${
                  ...
                  Développeuse Full Stack passionnée par l&apos;innovation et la créativité
                </p>
                <div className="flex justify-center md:justify-start gap-4">
                  <motion.a
                    href="https://github.com/leslie-ouinsou"
                    target="_blank"
                    rel="noopener noreferrer"
                    whileHover={{ scale: 1.1, y: -2 }}
                    whileTap={{ scale: 0.95 }}
              ...
              >
                ...
                <div className="flex flex-wrap justify-center md:justify-end gap-2">
                  {['React', 'Next.js', 'TypeScript', 'Node.js', 'MongoDB', 'Docker'].map((tech, index) => (
                    <motion.span
                      key={tech}
                      initial={{ opacity: 0, scale: 0.8 }}
                      whileInView={{ opacity: 1, scale: 1 }}
